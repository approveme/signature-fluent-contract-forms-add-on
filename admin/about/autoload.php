            ...
            switch ($esigStatus){
                ...
                case 'wpe_active_pro':
                  ...
                  if (!function_exists('wpFluentForm')) {// Notice about add-on dependent 3rd party plugin if not installed
                   return '<span class="esig-icon-esig-alert"></span><h4>Fluent forms plugin is not installed. Please install Fluent forms version 2.0 or greater - <a href="https://wordpress.org/plugins/ninja-forms/">Get it here now</a></h4>';
                  }
