...
function fluentforms_message($esigStatus,$pluginName)
        {
            ...
            switch ($esigStatus){
                ...
                case 'wpe_inactive':
                  return '<h4> ' . esc_attr($asterisk) . 'Your WP E-Signature Core plugin is not enabled. Please install and activate it to use WP E-Signature. <a class="about-button" href="'. esc_url(esig_plugin_activation_link("e-signature/e-signature.php")) .'">Activate WP E-Signature</a></h4>';
                  break;
                case 'wpe_expired':
                  return '<h4>' . esc_attr($asterisk) . 'You willl need to activate your WP E-Signature license to run the Fluent Forms Signature add-on.  <a class="about-button" href="admin.php?page=esign-licenses-general">Enter your license here</a> </h4>';
                  break;
                ...
                case 'wpe_inactive_pro':
                  return '<h4>' . esc_attr($asterisk) . 'Your WP E-Signature Add-on plugin is not enabled. Please install and activate it to use WP E-Signature. <a class="about-button" href="'. esc_url(esig_plugin_activation_link("e-signature-business-add-ons/e-signature-business-add-ons.php")) .'">Enable Add-Ons</a></h4>';
                  break;
                case 'wpe_active_pro':

                  if (!check_plugin_installed('fluentform/fluentform.php')) {// Notice about add-on dependent 3rd party plugin if not installed
                  return '<h4>Fluent Forms plugin is not installed. Please install Fluent Forms version 4.3.0 or greater - <a href="https://wordpress.org/plugins/fluentform/">Get it here now</a></h4>';
                  }
