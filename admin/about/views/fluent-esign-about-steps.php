...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            ...
            <p>1. <a href="https://wordpress.org/plugins/fluent-forms/" target="_blank">fluent Forms</a><br>2. <a href="https://www.approveme.com/wp-e-signature/?utm_source=wprepo&utm_medium=link&utm_campaign=fluentforms">WP E-Signature</a> <em>(ultimate, business or professional license)<br> </em>3. E-Signature Business Pack <em>(included with the Ultimate and Pro license)<br> </em></p>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            ...
            <?php endif; ?>
            <p>To learn about stand alone documents, you can visit this <a href="https://wpe.approveme.com/article/156-basic-document-vs-stand-alone-document/?utm_source=wprepo&utm_medium=link&utm_campaign=fluentforms" target="_blank">helpful article</a></p>
        </div>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        <div class="approveme-column-2">
            ...
            <p>This step will vary based on your desired outcome. Digital signature by Approve Me is triggered when a fluent Form is submitted. This add-on gives you the ability to integrate fluent Form user data (that was inputted from the user when the form was submitted) into a new contract that will either be emailed to the user or will be displayed to the user after they submit you form.</p>


            <p>To insert data into a fluent Data, you will need the <a href="https://www.approveme.com/downloads/signer-input-fields/?utm_source=wprepo&utm_medium=link&utm_campaign=fluentforms">Custom Fields</a> add-on by ApproveMe <em>(Ultimate, Business or Pro license required).</em></p>

            <p><strong>How to add form fields data into a contract using fluent Forms</strong><br>
            <ol>
                <li>Navigate to the Signer Input Fields/Custom Fields icon and select "fluent Form Data".</li>
            ...
            <p><em>This is an example of the auto-generated shortcode that will get inserted into the document you are creating after you select your desired field data from your fluent Form.</em> <br><span class="ff-shortcode-wrap">[esigfluent formid="3" field_id="1" ]</span></p>
...
<div class="approveme-feature-section approveme-table">
    <div class="approveme-row">
        ...
        <div class="approveme-column-2">
            <h4><span class="esig-step">7</span> Finish setting up the fluent Form workflow/trigger</h4>
            ...
            <div align="center">
                <div class="approveme-btn"><a class="button-border" href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=fluentforms">Try a Live Demo of this Integration</a></div>
            </div>
            <br>
        </div>
    </div>
