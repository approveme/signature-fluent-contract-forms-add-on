...
class esigFluent extends IntegrationManager
{
    ...
    public function registerHooks()
    {
        ...
        add_filter('fluentform_global_addons', function ($addons) use ($isEnabled) {
            $addons['wpesignature'] = [
                ...
                'logo' => ESIG_FLUENT_ADDON_URL . "assets/images/e-signature-logo.svg",
    ...
    public function isEnabled()
    {
        ...
        return $globalModules && isset($globalModules['wpesignature']) && $globalModules['wpesignature'] == 'yes';
    }
}
